...
Tristate C4094::compute(size_t pin)
{
    ...
    switch (pin) {
        case 3:  // Q1
            return ((m_storageRegister >> 0) & 0x01) ? Tristate::False : Tristate::True;
        case 4:  // Q2
            return ((m_storageRegister >> 1) & 0x01) ? Tristate::False : Tristate::True;
        case 5:  // Q3
            return ((m_storageRegister >> 2) & 0x01) ? Tristate::False : Tristate::True;
        case 6:  // Q4
            return ((m_storageRegister >> 3) & 0x01) ? Tristate::False : Tristate::True;
        case 13: // Q5
            return ((m_storageRegister >> 4) & 0x01) ? Tristate::False : Tristate::True;
        case 12: // Q6
            return ((m_storageRegister >> 5) & 0x01) ? Tristate::False : Tristate::True;
        case 11: // Q7
            return ((m_storageRegister >> 6) & 0x01) ? Tristate::False : Tristate::True;
        case 10: // Q8
            return ((m_storageRegister >> 7) & 0x01) ? Tristate::False : Tristate::True;
...
void C4094::simulate(size_t tick)
{
    ...
    if (m_lastClock == Tristate::False && clock == Tristate::True) {
        ...
        // Make sure we stay within 8 bits
        m_shiftRegister &= 0xFF;
    }

    // On rising edge of strobe, transfer shift register to storage register
